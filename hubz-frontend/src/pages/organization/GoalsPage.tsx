  ...
  return (
    <div className="flex h-full flex-col gap-6 overflow-auto p-6">
      ...
      <div className="flex items-center justify-between">
        <div>
          <h2 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Objectifs</h2>
          <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
            Gérez les objectifs de votre organisation. La progression se calcule automatiquement en fonction des tâches associées.
          </p>
        </div>
