...
interface EditHabitModalProps {
  ...
  onClose: () => void;
  habit: Habit | null;
  onSubmit: (id: string, data: { name: string; icon: string; frequency: HabitFrequency }) => Promise<void>;
}

export default function EditHabitModal({ isOpen, onClose, habit, onSubmit }: EditHabitModalProps) {
  ...
  return (
    <Modal isOpen={isOpen} onClose={onClose} title="Modifier l'habitude">
